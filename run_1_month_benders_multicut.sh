#!/bin/bash                                              
#SBATCH --job-name=RTS_1_month_benders_multicut   # create a short name for your job
#SBATCH --ntasks=1
...
julia -t 10 --project=./ ./example_systems/RTS_Case_Latest/1_month_run_Benders_multicut.jl