...
heat_rate_mmbtu_per_mwh(t::SupplyTechnology) = PSIP.get_heat_rate_mmbtu_per_mwh(t)
"""Get [`SupplyTechnology`](@ref) `capital_costs`."""
investment_cost_mw(t::SupplyTechnology) = get_proportional_cost(get_capital_costs(t))
"""Get [`SupplyTechnology`](@ref) `dn_time`."""
down_time(t::SupplyTechnology) = get_dn_time(t)
"""Get [`SupplyTechnology`](@ref) `lifetime`."""
lifetime(t::SupplyTechnology) = get_lifetime(t)
"""Get [`SupplyTechnology`](@ref) `ramp_dn_percentage`."""
ramp_down_fraction(t::SupplyTechnology) = get_ramp_dn_percentage(t)
...
var_om_cost_per_mwh(t::SupplyTechnology) = get_proportional_term(get_value_curve(get_variable(get_operation_costs(t))))
"""Get [`SupplyTechnology`](@ref) `fixed_om_cost_per_mwhyr`."""
fixed_om_cost_per_mwhyr(t::SupplyTechnology) = get_fixed(get_operation_costs(t))
...
ramp_up_fraction(t::SupplyTechnology) = get_ramp_up_percentage(t)
...
min_power(t::SupplyTechnology) = get_min_generation_percentage(t)
...
up_time(t::SupplyTechnology) = get_up_time(t)
