#!/bin/bash                                              
#SBATCH --job-name=RTS_6_month_monolithic     # create a short name for your job
#SBATCH --ntasks=1
...
julia -t 14 --project=./ ./example_systems/RTS_Case_Latest/6_month_monolithic_reconductoring.jl