...
println("RTS INFORMATION")
println("Number of variables is ", num_variables(m))
println("Number of binary variables is ", sum(is_binary.(all_variables(m))))
...
println("EXPANDED RTS INFORMATION")
println("Number of variables is ", num_variables(m))
println("Number of binary variables is ", sum(is_binary.(all_variables(m))))
println("Number of integer variables is ", sum(is_integer.(all_variables(m))))
println("Number of constraints is ", length(all_constraints(m, include_variable_in_set_constraints = false)))
...
m = GenX.generate_model(mysetup, n_inputs[1], optimizer)
println("SINGLE ZONE INFORMATION")
println("Number of variables is ", num_variables(m))
println("Number of binary variables is ", sum(is_binary.(all_variables(m))))
println("Number of integer variables is ", sum(is_integer.(all_variables(m))))
println("Number of constraints is ", length(all_constraints(m, include_variable_in_set_constraints = false)))
