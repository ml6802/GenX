...
# Run TDR
cluster_inputs(case, settings_path, mysetup; inputs = myinputs, minmaxperiods = (12,16))
...
# Run TDR
cluster_inputs(case, settings_path, mysetup; inputs = myinputs, minmaxperiods = (16,20))
...
# Run TDR
cluster_inputs(case, settings_path, mysetup; inputs = myinputs, minmaxperiods = (20,24))
