...
optimizer = optimizer_with_attributes(Gurobi.Optimizer, "TimeLimit" => 9600, "MIPGap" => 5e-3)
...
new_cap = [90,30,56,204,203,189,222,173,187,202,221]
new_cap_sizes = [3,1,2,3,4,2,2,2,1,1,3]
new_reconductor = [45,84,75]
new_lines = [212,201,234,159,209,204,205,183,231]
r_low = [84,75,45,]
r_high = [45,84]
r_low_sizes = [40,47.325,40]
r_high_sizes = [60,60]
...
println("SOLVING WITH FULL WATERFLOW SOLUTION")
