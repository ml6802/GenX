...
p.internal.ext["sub_weights"] = [8784/13 for i in 1:1]
...
mysetup["IntegerInvestment"] = 1

optimizer = optimizer_with_attributes(Gurobi.Optimizer, "TimeLimit" => 36000, "MIPGap" => 1e-3)
###### ZONAL ######
