...
solver = optimizer_with_attributes(Gurobi.Optimizer, "TimeLimit" => 600, "QCPDual" => 1)
...
set_optimizer_attribute(new_model, "max_cpu_time", 1800.)
import HSL_jll
set_attribute(new_model, "hsllib", HSL_jll.libhsl_path)
set_attribute(new_model, "linear_solver", "ma57")
...
set_optimizer_attribute(new_model, "max_iter", 50)
set_optimizer_attribute(new_model, "warm_start_init_point", "yes")
set_optimizer_attribute(new_model, "warm_start_bound_push", 1e-7)
set_optimizer_attribute(new_model, "warm_start_slack_bound_push", 1e-7)
set_optimizer_attribute(new_model, "warm_start_mult_bound_push", 1e-7)
#set_optimizer_attribute(new_model, "mu_init", 1e-5)
set_start_value.(avs, sols)
optimize!(new_model)
...
set_optimizer_attribute(new_model, "tol", 1e-8)
set_optimizer_attribute(new_model, "acceptable_tol", 1e-6)
set_optimizer_attribute(new_model, "max_iter", 50)
set_optimizer_attribute(new_model, "start_with_resto", "no")
