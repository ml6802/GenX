...
mysetup["DC_OPF"] = 1
optimizer = optimizer_with_attributes(Gurobi.Optimizer, "TimeLimit" => 40, "MIPGap" => 1e-2)#1e-4)
m = GenX.generate_model(mysetup, myinputs, optimizer)
# optimize!(m)

# z_cand_lines = [125, 143, 144, 190, 195]

# for (i, r) in enumerate(myinputs["RESOURCES"])
#     println(i, "   ", parent(r)[:resource])
# end

# for i in z_cand_lines
#     fix(m[:vNEW_TRANS_CAP_DECISION_INT][i, 1], 0, force=true)
# end
...
# for v in m[:vRECONDUCTOR_SLACK_LOW]
#     if value(v) != 0
#         println(v, "  ", value(v))
#     end
# end
...
# for v in m[:vRECONDUCTOR_SLACK_HIGH]
#     if value(v) != 0
#         println(v, "  ", value(v))
#     end
# end

# z_exist_lines = [5, 23, 24, 70, 75]
# z_cand_lines = [125, 143, 144, 190, 195]
# for line in z_exist_lines
#     println()
#     println()
#     println()
#     println(line)
#     for i in 1:168
#         println(value(m[:vFLOW][line, i]))
#     end
# end

# for line in z_cand_lines
#     println()
#     println()
#     println()
#     println(line)
#     for i in 1:168
#         println(value(m[:vCANDFLOW][line, i, 1]))
#     end
# end