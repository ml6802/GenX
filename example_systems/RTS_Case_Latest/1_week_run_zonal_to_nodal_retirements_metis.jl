...
# plot_graph(dg, nodecolor = get_node_data(dg, "color_subareas"), nodesize = 6, xdim = 500, ydim = 500, save_fig = false, linewidth=2, linecolor = "black", fig_name = (@__DIR__)*"/zonal_system_9parts.png")
