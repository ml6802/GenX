...
use_offical_lengths = Bool(parse(Int, ARGS[1]))
use_level_set = Bool(parse(Int, ARGS[2]))
use_bilinear = Bool(parse(Int, ARGS[3]))
sampling_number = parse(Int, ARGS[4])
...
load_candidates_base(myinputs, 8784, add_new_corridors = true, use_official_lengths = use_offical_lengths)
