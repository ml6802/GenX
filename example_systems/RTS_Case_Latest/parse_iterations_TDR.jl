...
data = parse_iteration_data((@__DIR__)*"/TDR_benders_results.txt")
...
data2 = parse_gurobi_data((@__DIR__)*"/TDR_monolithic_results.txt")
push!(data2.iteration, 2)
push!(data2.UB, data2.UB[1])
push!(data2.LB, data2.LB[1])
push!(data2.gap, data2.gap[1])
push!(data2.time, 64800)
...
plot!([],[], yaxis = :log, color = "red", label="Optimal Solution of LP Waterflow", linewidth = 1, linestyle = :dash)
...
plot!([0, cputimes2[end]], [1.7889e9, 1.7889e9], color = "red", label = :none, linewidth = 1, linestyle = :dash)
plot!(cputimes2, data2.UB, yaxis = :log, color = "blue", label = :none, linewidth = 2)
plot!(cputimes2, data2.LB, yaxis = :log, color = "blue", label = :none, linewidth = 2, linestyle = :dash)
